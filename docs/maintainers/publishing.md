...
These are the most stable and least framework-heavy. Their first public versions are currently frozen at `0.1.0`, and the current Wave 1 handoff material lives in `pack-db-wave1.md`.
